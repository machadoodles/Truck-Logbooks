...
const removeRecipe = id => {
  ...
  return (
    <div className="App">
      ...
      <button onClick={() => setPopupActive(!popupActive)}>Add hours</button>
                    ...
                    <div className="popup-inner">
                      ...
                      <div className="form-group">
                          ...
                          <div className="form-group">
                            ...
                            <textarea type="text" value={form.desc} 
                          ...
                          <div className="form-group">
                            ...
                            <button type="button" onClick={handleIngredientCount}>Add Ingredients</button>
                          </div>
                          ...
                          <div className="form-group">
                            ...
                            <div className="buttons">
                              ...
                              onClick={() => setPopupActive(false)}>Close</button>
                            </div>
                      </form>
                </div>
          </div>}
